...
rivers: {
  ...
  meta: {
    emoji: "🌊",
    subtitle: "Geografia Fluviale",
    description: "Sorgenti, foci, affluenti e meandri. Esplora i fiumi d'Italia e d'Europa.",
    gradient: "linear-gradient(135deg, #004D40 0%, #0288D1 100%)",
    textColor: "#E0F7FA",
    accentColor: "#4DD0E1"
  },
...
leopardi: {
    ...
    meta: {
      emoji: "📜",
      subtitle: "Letteratura Italiana",
      description: "Il pessimismo individuale, storico e cosmico. La vita e il pensiero di Giacomo Leopardi.",
...
gettingToKnow: {
    ...
    meta: {
      emoji: "🤝",
      subtitle: "English Grammar & Speaking",
      description: "Present Simple, possessivi e domande in inglese — il tutto conoscendo meglio i tuoi compagni!",
      gradient: "linear-gradient(135deg, #006064 0%, #FF4B4A 100%)",
      textColor: "#F3EBDE",
      accentColor: "#F1FF9D"
    },
